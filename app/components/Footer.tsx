...
export default function AdvancedFooter() {
  ...
  return (
    <footer className="bg-gradient-to-br bg-gradient-to-br from-slate-50 to-blue-100 text-black relative overflow-hidden">
      {/* Main Footer Content */}
        ...
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="space-y-4 sm:space-y-6 max-w-2xl">
            <div className="flex items-center justify-center gap-2 sm:gap-3">
              ...
              <div className="flex gap-0.5 sm:gap-1">
                <div className="w-4 h-5 sm:w-5 sm:h-7 bg-purple-500 rounded" />
                <div className="w-4 h-5 sm:w-5 sm:h-7 bg-blue-500 rounded" />
              </div>
            ...
            <p className="text-sm sm:text-base text-gray-400 leading-relaxed">
              Streamline your hiring process with AI-powered applicant tracking
              solutions. Enhance recruitment efficiency and make smarter
              decisions.
            </p>
            ...
            <div className="flex gap-4 sm:gap-5 justify-center flex-wrap">
              ...
              <a
                href="#"
                className="group w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center bg-white/10 hover:bg-blue-500 rounded-full transition-all duration-300 backdrop-blur-sm border border-white/20 hover:border-blue-500"
              >
                <svg
              ...
              <a
                ...
                target="_black"
                className="group w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center bg-white/10 hover:bg-gradient-to-tr hover:from-purple-600 hover:to-pink-600 rounded-full transition-all duration-300 backdrop-blur-sm border border-white/20 hover:border-pink-600"
              >
                <svg
                  className="w-5 h-5 sm:w-6 sm:h-6 hover:text-white"
                  fill="currentColor"
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
              <input
                ...
                className="flex-1 sm:flex-none w-full sm:w-64 lg:w-80 px-4 sm:px-6 py-2.5 sm:py-3 bg-white/70 border border-blue/50 rounded-full text-sm sm:text-base text-white placeholder-gray-400 focus:outline-none focus:border-purple-500 backdrop-blur-sm "
              />
              <button className="w-full sm:w-auto px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 rounded-full font-semibold text-sm sm:text-base transition-all shadow-lg hover:shadow-purple-500/50 whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
      ...
      {/* Decorative Elements */}
      <div className="absolute bottom-0 left-0 w-full h-0.5 sm:h-1 bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600" />
      ...
      <div className="fixed bottom-6 right-6 z-50">
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/80">We are here to help!</p>
                </div>
              </div>
              <button
            ...
            <div className="p-4 bg-white border-t border-gray-200">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="w-10 h-10 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg"
                >
        ...
        <button
          ...
          className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-all duration-300 hover:shadow-purple-500/50"
        >
          {isChatOpen ? (
