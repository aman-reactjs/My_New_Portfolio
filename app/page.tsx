        ...
        <div className="relative mt-5 min-h-screen text-white py-5 ">
          ...
          <div className="w-12 h-100 absolute right-10 top-35">
            <div className=" hidden md:grid sm:grid gap-4 sm:gap-5 justify-center flex-wrap ">
              ...
              <a
                ...
                target="_black"
                className="group w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center bg-white/10 hover:bg-white/40 rounded-full transition-all duration-300 backdrop-blur-sm border border-white hover:border-gray-700"
              >
                <svg
                  className="w-5 h-5 sm:w-6 sm:h-6 hover:text-white"
                  fill="currentColor"
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-28 justify-between items-left px-1 sm:px-12 lg:px-30 py-30">
            ...
            <div className="w-full lg:w-120 flex flex-col justify-center text-center lg:text-left">
              ...
              {/* BUTTONS */}
              <div className="p-px flex gap-4 justify-center lg:justify-start mt-4">
                <div className="buttonBorder-animate group rounded-md transition-all duration-300 backdrop-blur-md">
                  <div className="absolute inset-1 -z-10 rounded-xl blur-lg bg-linear-to-r from-pink-500 via-purple-500 to-blue-500"></div>
                  <a
                  ...
                  >
                    <Button
                      variant="outline"
                      className="border-0.5 rounded-md border-blue-800 px-6 py-4 text-black font-semibold"
                    >
                      Hire Me
                      <ArrowRight className=" relative h-4 transform transition-all duration-300 group-hover:translate-x-1 group-hover:scale-110" />
                    </Button>
                  </a>
                </div>
                <div className="buttonBorder-animate group rounded-md transition-all duration-300 backdrop-blur-md ">
                  ...
                  <Button
                    ...
                    className="border-0.5 text-black hover:text-orange-400 rounded-m px-6 py-4 font-semibold"
                  >
                    About Me
                    <ArrowRight className="relative h-4 transform transition-all duration-300 group-hover:translate-x-1 group-hover:scale-110" />
                  </Button>
            ...
            <div className="flex justify-center">
              <div className="border-animate rounded-full p-1 relative md:w-70 lg:w-80 flex justify-center lg:justify-start  ">
                <Image
                  src="/my_logo/My_Image.png"
                  alt="Aman Sharma"
                  width={600}
                  height={400}
                  className="w-52 sm:w-64 sm:h-64 md:w-70 md:h-70 lg:w-80 lg:h-80 object-cover rounded-b-full rounded-t-full inset-0 "
                />
              </div>
            </div>
          </div>
